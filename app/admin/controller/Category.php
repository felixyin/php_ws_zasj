...
class Category extends Common
{
    ...
    public function index()
    {
        if ($this->categorys) {
            foreach ($this->categorys as $r) {
                ...
                if (/*$r['module'] == 'page'*/
                isSinglePage($r['module'])) {
                    $r['str_manage'] = '<a class="orange" href="' . url($r['module'] . '/edit', array('id' => $r['id'])) . '" title="修改内容"><i class="icon icon-file-text2"></i></a> | ';
                } else {
                    $r['str_manage'] = '';
                }
    ...
    public function del()
    {
        ...
        foreach ((array)$arr as $r) {
            ...
            isSinglePage($this->categorys[$r]['module'])) {
                $module = db($this->categorys[$r]['module']);
                $module->delete($r);
            }
        }
        $this->repair();
