/*
 ...
 Source Schema         : php_zasj

 Target Server Type    : MySQL
 Target Server Version : 100213
 File Encoding         : 65001

 Date: 25/02/2018 23:06:22
*/
...
CREATE TABLE `clt_ad` (
  ...
  `content` text DEFAULT NULL COMMENT '广告内容',
...
-- ----------------------------
BEGIN;
INSERT INTO `clt_ad` VALUES (35, '耐用性', 10, '/uploads/20180225/6e54ca3557dea3dbc707666bf5adf4c2.png', 'http://demo.111.com', 1519566817, 50, 1, '<p>\n                      <span>令人惊艳的是Technogel不会随时间而硬化或老化。它能保持其弹性和力学特性。为什么？这种创新的材料完全没有挥发性物质。它的组成部分不能分解或移动，所以它不会损坏。实际上，测试已经证明Technogel能<span>承受超过</span>300,000<span>次压力冲击而不发生影响性能的变形。这就是持久的舒适！</span></span>\n                    </p>');
INSERT INTO `clt_ad` VALUES (36, '变形性', 10, '/uploads/20180225/afdb50bc3a6f573f9b9cc25539ffb7c1.png', 'http://demo.222.com', 1519566904, 50, 1, '<p>\n                      <span>和海绵不同，Technogel能三维变形（上/下、右/左、等等），按照您的身体结构模塑自己并在整个接触表面上均匀分布压力。它能显著减少尖峰压力从而改善血液循环。內部测验证明了普通海绵床垫与加上Technogel层的相同海绵床垫的压力分布差距。感觉就是相信！</span>\n                    </p>');
INSERT INTO `clt_ad` VALUES (37, '枕头', 11, '/uploads/20180225/dea4d0ee1db78e5e6a22e9bc010aef0e.png', 'http://demo.444.com', 1519566983, 2014, 1, '当Technogel不断为工业领域增添价值时，我们推出了第一条自有品牌产品线Technogel Sleeping，它令人恢复活力的优点革新了夜晚（以及白天！）。');
INSERT INTO `clt_ad` VALUES (38, '样车', 11, '/uploads/20180225/b5e8cb4dc10dbbc97fbf3d7847059491.png', 'http://demo.555.com', 1519567046, 2016, 1, '汽车设计师和建造商正在利用Technogel的力量打造奢华舒适且更加时尚的汽车内饰。');
COMMIT;
...
CREATE TABLE `clt_auth_group` (
  ...
  `rules` longtext DEFAULT NULL COMMENT '规则',
  `addtime` int(11) NOT NULL COMMENT '添加时间',
...
CREATE TABLE `clt_category` (
  ...
  `ext_content1` text DEFAULT NULL,
  `ext_content2` text DEFAULT NULL,
  `ext_content3` text DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `clt_category` VALUES (26, '床垫', 'mcategory', '', 0, 24, 'msub', '0', '26,30,31', 0, '床垫', '', '', 1, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '长期以来，Technogel®通过凉爽的软垫和出色的人体工程学支撑振奋着日常的生活体验——从轮椅和医疗到自行车、就座、行走和睡眠。我们继承创新的传统，是第一个也是唯一一个使用加厚专利凝胶层的床垫品牌。 基于23年使用凝胶让生活变得更舒适的经验，Technogel®通过凉爽舒适的支撑革新了床垫，经过科学验证能帮助您睡得更好。 现在我们与您分享我们的灵感：只有Technogel®才能提供的优点，帮助您以一种焕然一新的方式享受生活。', '', '', '', '', '', NULL);
INSERT INTO `clt_category` VALUES (29, '坐垫', 'mcategory', '', 0, 21, 'mproduction', '0', '29', 0, '', '', '', 2, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '1朝九晚五以及从1号公路到66号公路，您花了大量时间就座；您也该面带微笑。Technogel® Living座垫强化了正确坐姿并为您的尾骨和下背部提供极致的凉爽舒适。 起初为医疗领域开发，Technogel是一种创新的柔软固体材料，可以三维变形，提供完美的支撑从而缓解压力。通过在记忆海绵上模塑这种独特的凝胶，我们创造了Technogel Living产品，提供全天的卓越支撑和舒适。因此，您可以24小时并在高速公路和旁路上保持放松和毫无压力。', '朝九晚五以及从1号公路到66号公路，您花了大量时间就座；您也该面带微笑。Technogel® Living座垫强化了正确坐姿并为您的尾骨和下背部提供极致的凉爽舒适。 起初为医疗领域开发，Technogel是一种创新的柔软固体材料，可以三维变形，提供完美的支撑从而缓解压力。通过在记忆海绵上模塑这种独特的凝胶，我们创造了Technogel Living产品，提供全天的卓越支撑和舒适。因此，您可以24小时并在高速公路和旁路上保持放松和毫无压力。', '', '', '', '', 0);
INSERT INTO `clt_category` VALUES (28, '旅行', 'mcategory', '', 0, 21, 'mproduction', '0', '28', 0, '', '', '', 3, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '', '', '', '', '', '', 0);
INSERT INTO `clt_category` VALUES (30, '原创系列', 'msub', 'mcategory/', 26, 21, 'mproduction', '0,26', '30', 0, '', '', '', 11, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '在第一个也是唯一一个使用适应身体的Technogel®凝胶层的床垫品牌上精神焕发地醒来。精心设计的4种不同核心构造可以满足对坚实或柔软床垫的多种偏好。', '是什么激发您起床并制造影响力？一晚的良好睡眠具有改革的能力。您充满能量地醒来。您感到一整天都更积极。此外，当早晨是平静和清新的，您变得精神焕发。所以，避免在夜间闷热、流汗或因不适而辗转反侧，享受不受打断的睡眠的益处——根据临床测试，增加多达45%的深度睡眠！Technogel® Sleeping不仅意味着设计出最佳的床垫，更意味着生活到极致。', '', '/uploads/20180224/8c05b401fa38660f61761bea1fd298a1.jpg', '', '', 1);
INSERT INTO `clt_category` VALUES (31, 'VIVE系列', 'msub', 'mcategory/', 26, 21, 'mproduction', '0,26', '31', 0, '', '', '', 12, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '在床垫上使用前所未有的大量凝胶，意味着更多的适应性支撑。用极致的睡眠宠爱自己。舒适是新的奢华。', '使用1.25英寸的身体适应性凝胶 ，VIVE提供顶级放松，令舒适成为新的奢华。', '', '/uploads/20180224/a848f21a29b64945257c0bd58c5713d1.png', '', '', 0);
INSERT INTO `clt_category` VALUES (35, '关于', 'mabout', '', 35, 27, 'mabout', '0', '35', 0, '', '', '', 10, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '', '', '', '', '', '', 0);
INSERT INTO `clt_category` VALUES (36, '关于', 'mabout', '', 0, 27, 'mabout', '0', '36', 0, '', '', '', 5, 0, 1, 0, '', 0, '', '', '', 0, '1,2,3', 0, 0, '', '', '', '', '', '', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `clt_debris` VALUES (38, 11, '创新材料', '<p class=\"description hidden-xs\" style=\"text-align: center;\">想象一下有一种如此独特和富有弹性的物体，激发您脱离惯性思维，以新鲜的视角处理日常生活。从您早晨起床的那一刻起到享受放松的每个夜晚，Technogel正在改变着每日体验。不仅是一种杰出的技术，它还是一种更舒适的生活方式。</p><ul class=\"list-features list-unstyled list-inline\" style=\"text-align: center;\"><li><span class=\"icon-svg\"></span><span class=\"txt\" style=\"text-align: left;\">缓解<br>压力</span></li>&nbsp;<li><span class=\"icon-svg\"></span><span class=\"txt\" style=\"text-align: left;\">人体工程学<br>支撑</span></li>&nbsp;<li><span class=\"icon-svg\"></span><span class=\"txt\" style=\"text-align: left;\">生物相容性 —&nbsp;<br>无毒及健康</span></li>&nbsp;<li><span class=\"icon-svg\"></span><span class=\"txt\" style=\"text-align: left;\">加强的透气性<br>和温度调节</span></li></ul>', 1519546297, 50, '/uploads/20180225/5a55491d60f56d0f1168c3718ad4b14f.jpg', '');
INSERT INTO `clt_debris` VALUES (37, 10, '舒适站立', '<p><span>向您介绍全新的Technogel站立伙伴。</span></p>', 1519546225, 50, '/uploads/20180225/b58dd2fe843dca88cdde945f7fc3dfc4.jpg', '');
INSERT INTO `clt_debris` VALUES (31, 8, '精神焕发地<br/>醒来', '<p>醒来</p>', 1519545577, 50, '/uploads/20180225/5dd51b2322cbe39c20df8d2007037e66.jpg', 'home-msub-index-catId-30.html');
INSERT INTO `clt_debris` VALUES (32, 9, '床垫', '<p><span>发现凝胶床垫领导者的凉爽舒适支撑的优点。具有身体适应性的加厚Technogel®层经过临床测试证明，可以帮助您入眠并享受更深度的睡眠。</span></p>', 1519545698, 52, '/uploads/20180225/239df298ebfc59ac51fbf376ae007ef6.jpg', 'home-mcategory-index-catId-26.html');
INSERT INTO `clt_debris` VALUES (33, 9, '枕头', '<p><span>通过创新和透气性的设计，Technogel®被无缝模塑至记忆海绵，一系列的形状和尺寸令你获得最舒适的头部和颈部支撑。这才是出色的枕头！</span></p>', 1519545791, 51, '/uploads/20180225/e1f506fb67fe074fb6e4daeb702871e4.jpg', 'home-mcategory-index-catId-28.html');
INSERT INTO `clt_debris` VALUES (34, 10, '深入了解', '<p><span>在Technogel公司，我们致力于制造、研发、测试和推出创新产品，令您的生活更舒适</span></p>', 1519545970, 50, '/uploads/20180225/cfaac4bf751361405aa965d6d48df28d.jpg', '');
INSERT INTO `clt_debris` VALUES (35, 10, '更愉快的旅行', '<p><span>带上最新的便携式凝胶垫。</span></p>', 1519546049, 50, '/uploads/20180225/ab0be07ef8b0b1b1764bccc0b5d6b46b.jpg', '');
...
INSERT INTO `clt_field` VALUES (233, 24, 'catid', '栏目', '', 1, 0, 0, 'defaul', '', 'catid', 'catid', NULL, 0, '', 0, 1, 0);
...
INSERT INTO `clt_field` VALUES (216, 21, 'catid', '所属分类', '', 1, 0, 0, 'defaul', '', 'catid', 'catid', NULL, 0, '', 0, 1, 0);
...
INSERT INTO `clt_field` VALUES (240, 25, 'catid', '栏目', '', 1, 0, 0, 'defaul', '', 'catid', 'catid', NULL, 0, '', 0, 1, 0);
...
INSERT INTO `clt_field` VALUES (244, 21, 'pictures', '轮播图片', '', 1, 0, 0, 'defaul', '', 'pictures', 'images', NULL, 0, '', 5, 1, 0);
...
-- ----------------------------
-- Table structure for clt_mabout
-- ----------------------------
...
-- ----------------------------
-- Records of clt_mabout
-- ----------------------------
BEGIN;
INSERT INTO `clt_mabout` VALUES (36, '关于', 'color:hsv(0, 0%, 0%);font-weight:bold;', '/uploads/20180225/a81f83cae31c1d8ae9250a1dc68e6670.jpg', 0, 1, 0, '', 0, 1519567732, 1519569692, 0, 'mabout_show', '<p><span style=\"color: rgb(242, 242, 242);\">向下滚动详细了解我们的专利凝胶技术</span></p>', '', '', '/uploads/20180225/139f7d5eedb3053327c1b806d0849fe3.jpg', '25年制造经验', '<p><span style=\"font-family: lexia; text-align: center; background-color: rgb(255, 255, 255);\">感谢25年的创新德国工艺和意大利设计，我们创造了真正激动人心的事物——人体工程学的新浪潮。这一切始于一种不同寻常的材料和一个男人的梦想……</span></p>', '发现优点', '应用', '创新材料', '<p><span style=\"font-family: lexia; text-align: center; color: rgb(0, 0, 0);\">是什么令这种创新凝胶可以有如此多的完美应用？发现为什么从建筑师到艺术家到工程师、运动员和建造商，每个人都以全新和创新的方式使用Technogel。</span></p>', '/uploads/20180225/df4940c33d6328792c33cb3ec894106d.jpg');
COMMIT;

-- ----------------------------
-- Table structure for clt_mcategory
-- ----------------------------
...
-- ----------------------------
BEGIN;
INSERT INTO `clt_module` VALUES (27, '关于模型', 'mabout', '', 1, 0, '*', NULL, 0, 1, 1);
INSERT INTO `clt_module` VALUES (21, '产品模型', 'mproduction', '', 1, 0, '*', NULL, 0, 1, 0);
INSERT INTO `clt_module` VALUES (25, '分类模型', 'mcategory', '', 1, 0, '*', NULL, 0, 0, 0);
INSERT INTO `clt_module` VALUES (24, '子分类模型', 'msub', '', 1, 0, '*', NULL, 0, 1, 0);
COMMIT;

-- ----------------------------
-- Table structure for clt_mproduction
-- ----------------------------
...
-- ----------------------------
-- Records of clt_mproduction
-- ----------------------------
BEGIN;
INSERT INTO `clt_mproduction` VALUES (1, 'Estasi柔软款', 'color:;font-weight:bold;', '/uploads/20180223/b64dff7f13775f15b3c0a4cf6ac1f098.png', 65, 1, 1, 'admin', 0, 1519356576, 1519356889, 0, 'mproduction_show', 30, '', '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgba(255, 255, 255, 0.75);\">1.7厘米厚的Technogel凝胶层令Estasi柔软款受到侧卧睡眠者或偏爱柔软舒适床垫的人士的欢迎。</span></p>', '/uploads/20180223/2bfc05dbfdbd89c919cb30eec2ebde05.jpg;/uploads/20180223/e5b0bedaf1c9350c8fc6ac119e6df7a7.png;', '/uploads/20180223/5e8eb78884e370741e0502a8b6ec547e.png', '定位缓冲', '独特的3-区域设计提供了额外的肩部和臀部缓冲以及下背部支撑。从您入睡的那一刻起到第二天起床时始终保持舒适。不必在早晨活动您的关节；精神焕发地醒来并整装待发。', '/uploads/20180223/05f5896aa200915d13975de2a6d0a20c.png', '', '', '', '', '个性化支撑', '', '', '', '', '', '我们称之为3D变形。您可以称之为前所未有的美好夜晚。像水一样具有适应性，又具有固体的支撑性，Technogel逐步且独特地适应您的身体，缓解压力的同时不限制运动。', '', '', '', '<p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">加厚的</span>Technogel<span style=\"box-sizing: border-box;\">层帮助您保持舒适和凉爽。独特的</span>3-<span style=\"box-sizing: border-box;\">区域设计为肩部和臀部提供额外缓冲以及下背部定位支撑。这一个性化的压力缓解令</span>Estasi<span style=\"box-sizing: border-box;\">柔软款床垫尤其受到侧卧睡眠者或偏爱柔软舒适床垫的人士的欢迎。</span></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">不再为了找到舒适睡姿而辗转反侧或因为闷热流汗而醒来，你将入睡并享受在最恢复精力的睡眠阶段不间断休息的益处。</span></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">通过</span>Estasi<span style=\"box-sizing: border-box;\">极致的凝胶体验，您可以每晚享受令人精神焕发的睡眠。感觉就是相信。寻找授权的</span>Technogel®<span style=\"box-sizing: border-box;\">床垫零售商并访问您附近的商店，发现远胜其他品牌的杰出产品。</span></p><p><br/></p>', '<ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p>25 厘米总厚度</p></li><li><p>1.7厘米厚Technogel®层</p></li><li><p>人体工程学设计</p></li><li><p>意大利设计和制造</p></li><li><p>设计师风格，带薄款和厚款拉链保护套</p></li><li><p>保修: 5+5 年</p></li></ul><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box; font-weight: 700;\">现有尺寸</span></p><ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p>90 x 200 x 25 厘米</p></li><li><p>100 x 200 x 25 厘米<span class=\"s2\" style=\"box-sizing: border-box;\"><br/></span></p></li><li><p>80 x 200 x 25 厘米</p></li><li><p>90 x 190 x&nbsp;25 厘米</p></li><li><p>120 x 200&nbsp;x 25 厘米</p></li><li><p>140 x 200&nbsp;x 25 厘米</p></li><li><p>160 x 200 x 25 厘米</p></li><li><p>180 x 200 x 25 厘米</p></li><li><p>200 x 200 x 25 厘米</p></li></ul><p><br/></p>');
INSERT INTO `clt_mproduction` VALUES (2, 'Estasi坚实款', 'color:;font-weight:bold;', '/uploads/20180223/dba14531d7f9c15c6795275c57cd548a.png', 112, 1, 1, 'admin', 0, 1519356645, 0, 0, 'mproduction_show', 30, '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgb(244, 244, 244);\">1.7厘米厚的Technogel凝胶层令Estasi坚实款成为喜爱舒适和更强支撑感的海绵床垫的人士的理想选择。</span></p>', '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgba(255, 255, 255, 0.75);\">1.7厘米厚的Technogel凝胶层令Estasi坚实款成为喜爱舒适和更强支撑感的海绵床垫的人士的理想选择。</span></p>', '/uploads/20180223/640e579b6478f24f8ebb5bc624da9621.jpg;/uploads/20180223/5f69b9820174295b1e1b69f6dabe26e9.png;', '/uploads/20180223/f8814efffda563f7e2a5fe47717f6cd7.png', '深度睡眠从这里开始', '临床测试显示 Technogel®床垫有助减少多达33%的浅度睡眠，增加多达45%的深度睡眠。这是令人大开眼界的事实！', '/uploads/20180223/408a3fb50f03ef6aa939a443fd5c7e21.png', '', '', '', '', '健康的细节', '', '', '', '', '', 'Technogel® 是唯一一种不使用塑化油的聚氨酯凝胶——它无毒、近乎无味且不随温度或使用年限而硬化或软化。它是一种具有生物相容性和弹性的专利柔软固体凝胶。这意味着您可以轻松地躺下并让您的忧虑飘远。', '', '', '', '<p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">加厚的</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Technogel</span><span style=\"box-sizing: border-box;\">层帮助您保持舒适和凉爽。独特的</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">3-</span><span style=\"box-sizing: border-box;\">区域设计为肩部和臀部提供额外缓冲以及下背部定位支撑。这一个性化的压力缓解令</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Estasi坚实</span><span style=\"box-sizing: border-box;\">款床垫尤其受到侧卧睡眠者或偏爱坚实支撑床垫的人士的欢迎。</span></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">不再为了找到舒适睡姿而辗转反侧或因为闷热流汗而醒来，你将入睡并享受在最恢复精力的睡眠阶段不间断休息的益处。</span></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">通过</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Estasi</span><span style=\"box-sizing: border-box;\">极致的凝胶体验，您可以每晚享受令人精神焕发的睡眠。感觉就是相信。寻找授权的</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Technogel®</span><span style=\"box-sizing: border-box;\">床垫零售商并访问您附近的商店，发现远胜其他品牌的杰出产品。</span></p><p><br/></p>', '<ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p>25 厘米总厚度</p></li><li><p>1.7&nbsp;<span style=\"box-sizing: border-box;\">厘米厚</span>Technogel®层</p></li><li><p>人体工程学设计</p></li><li><p><span style=\"box-sizing: border-box;\">意大利设计和制造</span></p></li><li><p><span style=\"box-sizing: border-box;\">设计师风格，带薄款和厚款拉链保护套</span></p></li><li><p><span style=\"box-sizing: border-box;\">保修</span>: 5+5&nbsp;<span style=\"box-sizing: border-box;\">年</span></p></li></ul><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box; font-weight: 700;\">现有尺寸:</span></p><ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p>90 x 200 x 25 厘米</p></li><li><p>100 x 200 x 25 厘米</p></li><li><p>80 x 200 x 25 厘米</p></li><li><p>90 x 190 x 25 厘米</p></li><li><p>120 x 200 x 25 厘米</p></li><li><p>140 x 200 x 25 厘米</p></li><li><p>160 x 200 x 25 厘米</p></li><li><p>180 x 200 x 25 厘米</p></li><li><p>200 x 200 x 25 厘米</p></li></ul><p><br/></p>');
INSERT INTO `clt_mproduction` VALUES (3, '腰枕', 'color:;font-weight:normal;', '/uploads/20180225/af84937a4afc894a91cfb7936beea150.png', 9, 1, 1, 'admin', 0, 1519550801, 1519552092, 0, '0', 29, '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgb(228, 228, 228);\">使用凉爽凝胶强化您脊柱的天然曲度，长时间就座不再意味着不适和下背部压力。</span></p>', '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgba(255, 255, 255, 0.75);\">使用凉爽凝胶强化您脊柱的天然曲度，长时间就座不再意味着不适和下背部压力。</span></p>', '/uploads/20180225/5d40d16566290dd8b8ec45297d514303.png;/uploads/20180225/f6d866875c6847701e3c8905ca4ea784.png;', '', '针对下背部疼痛', '经过人体工程学设计，为最为日常的活动——就座提供卓越舒适。只要将腰枕放于背后，您就可以和下背部疼痛告别了。', '', '', '', '', '', '凉爽的温度调节', '', '', '', '', '', 'Technogel®是一种天然的热导体，您可以享受凉爽的感觉，保持放松、无压力并专注于手上的工作。', '', '', '', '<p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">在办公室、家中或路上放松您的肌肉并享受绝佳的背部支撑。</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Technogel</span><span style=\"box-sizing: border-box;\">腰枕强化您脊柱的天然曲度，令长时间就座不再意味着不适和下背部压力。</span></p><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">朝九晚五，从</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">1</span><span style=\"box-sizing: border-box;\">号公路到</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">66</span><span style=\"box-sizing: border-box;\">号公路，您花了大量时间就座；您也该面带微笑。寻找授权的</span><span style=\"box-sizing: border-box; font-family: Verdana, sans-serif;\">Technogel® Living</span><span style=\"box-sizing: border-box;\">座垫零售商并访问您附近的商店，发现如此简单的支撑垫如何改善您的生活和未来。</span></p><p><br/></p>', '<ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;Technogel<span style=\"box-sizing: border-box;\"><span style=\"box-sizing: border-box;\">模塑至记忆海绵底座</span></span><br/></span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;耐用的可水洗考杜拉面料保护套</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;出色的压力缓解<br/></span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;意大利制造</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;<span style=\"box-sizing: border-box;\"><span style=\"box-sizing: border-box;\">生物相容性、无毒、近乎无味</span></span><br/></span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;<span style=\"box-sizing: border-box;\">2<span style=\"box-sizing: border-box;\">年保修</span>+1<span style=\"box-sizing: border-box;\">年登记保修</span>&nbsp;(<span style=\"box-sizing: border-box;\">免费</span>) = 3<span style=\"box-sizing: border-box;\">年保修</span></span></span></p></li></ul><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">&nbsp;</span></p><ul style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\" class=\" list-paddingleft-2\"><li><p><span style=\"box-sizing: border-box; font-weight: 700;\">现有尺寸</span></p></li><li><p>12 x 10.5 x 2 英寸</p></li></ul><p><br/></p>');
INSERT INTO `clt_mproduction` VALUES (4, '旅行枕', 'color:;font-weight:normal;', '', 15, 1, 1, 'admin', 0, 1519551805, 0, 0, '0', 28, '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgba(255, 255, 255, 0.75);\">体积小巧可方便地置于行李箱内，旅行枕帮助您在离家时获得美好睡眠。</span></p>', '<p><span style=\"font-family: lexia; font-size: 18px; background-color: rgba(255, 255, 255, 0.75);\">体积小巧可方便地置于行李箱内，旅行枕帮助您在离家时获得美好睡眠。</span></p>', '/uploads/20180225/ea6e29ac8529ab433c978d0eef484e72.png;/uploads/20180225/78e7cc04d90d664640e5195fb0886c65.png;', '', '便携的旅行尺寸', 'Technogel Sleeping的所有优点都集于舒适和提供支撑的凝胶记忆海绵枕中，尺寸按比例缩小后方便您带它去任何地方。', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '<p class=\"p1\" style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\">足够小巧可以方便地放置于您的行李中，Technogel<span class=\"s2\" style=\"box-sizing: border-box;\">®&nbsp;</span>旅行枕帮助您缓解在酒店床上辗转反侧，使您无论去哪里都可以获得优质的睡眠。</p><p class=\"p1\" style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\">令人放松而凉爽，这款小型凝胶枕头帮助您在汽车、火车或飞机上享受休息，也可以用于办公室小憩（嘘—我们不会告诉别人）。访问您附近的商店，选择您理想的旅行伴侣。</p><p><br/></p>', '<ul class=\"ul1 list-paddingleft-2\" style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;Technogel结合记忆海绵</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;将正常尺寸的人体工程学枕头的优点集于小巧尺寸</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;轻巧</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;Technogel模塑至记忆海绵底座</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;生物相容性、无毒、近乎无味</span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;意大利制造<br/></span></p></li><li><p><span class=\"s2\" style=\"box-sizing: border-box;\">—&nbsp;2年保修+1年登记保修 (免费) = 3年保修</span></p></li></ul><p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 15px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\"><span style=\"box-sizing: border-box;\">&nbsp;</span></p><ul style=\"box-sizing: border-box; padding: 0px; font-family: lexia; white-space: normal; background-color: rgb(255, 255, 255);\" class=\" list-paddingleft-2\"><li><p><span style=\"box-sizing: border-box; font-weight: 700;\">现有尺寸</span></p></li><li><p>12 x 12 x 4 英寸</p></li></ul><p><br/></p>');
COMMIT;

-- ----------------------------
-- Table structure for clt_msub
-- ----------------------------
...
CREATE TABLE `clt_plugin` (
  ...
  `config_value` text DEFAULT NULL COMMENT '配置值信息',
  ...
  `bank_code` text DEFAULT NULL COMMENT '网银配置信息',
...
-- ----------------------------
BEGIN;
INSERT INTO `clt_system` VALUES (1, '待定网站名称', 'http://www.zasj.com/', '待定网站名称', '床垫、坐垫、站垫', '叫哈哈哈哈哈哈哈哈哈哈哈哈哈', '青ICP备15008023号-6', '2017-2018', '青岛市xx区xx路xx大厦202', '15965585803', '22', '/uploads/20180225/a8bd7b6dce5f4f8006c97c4aea7d747e.png', '/uploads/20180116/ac9e81f21fa1c08e9a9cd09e8b8ebfe9.png', '22222', 'ddd', 11, 77, '得到的点点滴滴');
COMMIT;
...
CREATE TABLE `clt_wx_user` (
  ...
  `menu_config` text DEFAULT NULL COMMENT '菜单',
